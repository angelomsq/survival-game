...
export default class Player extends Character {
  ...
  setBullets(bullets) {
    //create new bullets for new player
  ...
  getHealthBar() {
    ...
    for (let i = 0; i < this.maxHealth; i++) {
      ...
      if (this.scene.healthBar[i]) this.scene.healthBar[i].setTexture(color)
        ...
        this.scene.healthBar.push(
          this.scene.add.sprite(heartX, 8, color).setScrollFactor(0).setDepth(3)
        )
    }
  }
